          ...
          <div class="row">
            <div class="col-md-4">
              <div class="licence-box"> <img src="imgs/icon-license-i5.png" class="mb4">
                ...
                <div class="lic-box-inner mb5 lic-i5"> <span>i5 Licenses Unactivated</span>
                  <p>5</p>
                </div>
                <div class="licence-box-btn lic-i5-btn mb2"> <a href="licenses-buy.php">Buy i5 Licenses</a> </div>
            ...
            <div class="col-md-4">
              <div class="licence-box"> <img src="imgs/icon-license-i25.png" class="mb4">
                ...
                <div class="lic-box-inner mb5 lic-i25"> <span>i25 Licenses Unactivated</span>
                  <p>0</p>
                </div>
                <div class="licence-box-btn lic-i25-btn"> <a href="licenses-buy.php">Buy i25 Licenses</a> </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="licence-box"> <img src="imgs/icon-license-i125.png" class="mb4">
                ...
                <div class="lic-box-inner mb5 lic-i125"> <span>i125 Licenses Unactivated</span>
                  <p>0</p>
                </div>
                <div class="licence-box-btn lic-i125-btn"> <a href="licenses-buy.php">Buy i125 Licenses</a> </div>
              </div>
            </div>
          </div>
        </div>
