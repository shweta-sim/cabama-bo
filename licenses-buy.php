            ...
            <div id="content"> 
                ...
                <div class="main-content">
                    ...
                    <div class="container-fluid p0"> 
                        <div class="row pt2">
                            <div class="col-md-4">
                                <div class="license-buy-box">
                                    <img src="imgs/icon-license-i5.png" class="mb4">
                                    <div class="license-name">CBM i5 Licenses</div>
                                    <p class="mb5">(5 Unactivated Licenses Available)</p>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="card license-buy-detail">
                                    <div class="card-content">
                                        <div class="license-detail">                                            
                                            <p class="mb4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra
                                            ...
                                            <table class="mb2" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="w2" data-label="Quantity">
                                                            <div class="disFlex">
